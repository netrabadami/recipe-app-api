...
def image_upload_image(recipe_d):
    """Return url for recipe image upload"""
    return reverse('recipe:recipe-upload-image', args=[recipe_d])
...
class PublicRecipeApiTest(TestCase):
    """Test unauthenticated receipe API"""
...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_create_basic_recipe(self):
        ...
        # check if payload values are inserted correctly into db and
        # the same is retrieved
        for key in payload.keys():
            self.assertEqual(payload[key], getattr(recipe, key))

    def test_create_receipe_with_tags(self):
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        ...
        url = image_upload_image(self.recipe.id)
    ...
    def test_filter_recipes_by_tags(self):
        """Test returning recipes with specifi tags"""
        ...
        recipe3 = sample_recipe(user=self.user, title='Fish woth chips')
    ...
    def test_filter_recipes_by_ingredients(self):
        """Test retutning recipes with specific ingredient"""
